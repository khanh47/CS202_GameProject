...
| `0x0020` | Prop | `PROP` | Decorative props that only collide with the environment |

Bits `0x0040` through `0x8000` are available for future categories.

---

## Filter Table

| ↓ Object (category) / → Interacts with | `0x0001` ENV | `0x0002` PLAYER | `0x0004` FIREBALL | `0x0008` ENEMY | `0x0010` PICKUP | `0x0020` PROP |
|---|---|---|---|---|---|---|
